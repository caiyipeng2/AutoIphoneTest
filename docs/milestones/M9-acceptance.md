...
console by M9 Task 26; explicit Action Skip is provided by M9 Task 27; paused
quarantined-follower rejoin is provided by M9 Task 28; paused active-follower
Leader promotion is provided by M9 Task 29 and exposed in the Sessions
console by M9 Task 30.
...
The Appium driver/device discovery blocker is resolved for the current environment. Appium-only operation is explicit and does not silently weaken the strict Bridge default. The physical fault/recovery acceptance evidence is recorded in [M9 Task 22](M9-task22-fault-recovery-acceptance.md), the explicit resume/rebuild contract in [M9 Task 23](M9-task23-explicit-resume-acceptance.md), the explicit action retry contract in [M9 Task 24](M9-task24-action-retry-acceptance.md), the console pause/resume controls in [M9 Task 25](M9-task25-session-controls-acceptance.md), the console action retry surface in [M9 Task 26](M9-task26-action-retry-console-acceptance.md), explicit Action Skip in [M9 Task 27](M9-task27-action-skip-acceptance.md), paused quarantined-follower rejoin in [M9 Task 28](M9-task28-device-rejoin-acceptance.md), and paused Leader promotion in [M9 Task 29](M9-task29-leader-promotion-acceptance.md). M10 remains independently accepted; physical promotion acceptance remains a separate hardware gate.

The console control evidence is recorded separately in [M9 Task 30](M9-task30-leader-promotion-console-acceptance.md). Task 30 is locally complete and awaits approval before its commit/push; physical two-device promotion remains a separate hardware gate.
